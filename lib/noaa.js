...
async function fetchChlorophyll(reqDate){
  // Chlorophyll is fetched client-side in the browser
  // Server-side fetch is disabled as NOAA blocks Vercel IPs
  throw new Error('Chl fetched client-side');
}
const FL_BUOYS=[
  {id:'41070',name:'St Augustine',lat:30.044,lon:-80.533},
