...
async function fetchChlorophyll(reqDate){
  ...
  const datasets=[
    // Try multiple dates - go back up to 14 days to find valid data
    // Copernicus S-3A OLCI - Atlantic sector, 300m, near real-time
    {id:'noaacwS3AOLCIchlaSectorMKDaily', server:'https://coastwatch.pfeg.noaa.gov/erddap/griddap', variable:'chlor_a', stride:2},
